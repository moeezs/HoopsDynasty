...
<?php if (isset($_SESSION["userid"])) { ?>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function updatePlayerSpots(teamId) {
        if (!teamId) return;
